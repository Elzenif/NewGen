...
public class ProprieteSpecialeControllerTest {
  ...
  @Mock
  private ProprieteSpecialeArmureRepository proprieteSpecialeArmureRepository;
  @Mock
  private ProprieteSpecialeBouclierRepository proprieteSpecialeBouclierRepository;
  @Autowired
